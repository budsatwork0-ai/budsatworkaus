...
// Mirrors the Supabase enums in supabase/migrations/*_autonomy_pipeline.sql.
...
/**
 * Aggregated view assembled on the server (or in the client from realtime
 * deltas) — this is what the AutonomyPipeline component renders.
 */

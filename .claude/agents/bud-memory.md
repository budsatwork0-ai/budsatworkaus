...
If the change introduced a new system (new agent, new database table cluster, new API surface, new shared service), check whether `Buds At Work/01 Architecture/` has a relevant note to update. If not, create one.

// Shared SVG icons for auth pages — import from here instead of inlining.
...
export function EyeIcon({ open, className = 'h-4 w-4' }: { open: boolean; className?: string }) {
  if (open) {
    return (
...
export function ShieldIcon({ className = 'h-3 w-3' }: { className?: string }) {
  return (

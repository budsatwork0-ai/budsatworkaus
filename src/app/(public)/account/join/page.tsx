  ...
  return (
    <AuthSplitLayout variant="staff">
      ...
      <div className="flex rounded-xl border border-white/10 bg-white/5 p-1 mb-8">
        ...
        <Link
          href="/account/join"
          className="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-200 bg-indigo-600/90 text-white shadow-sm"
        >
          <BriefcaseSmIcon />
          Staff
        </Link>

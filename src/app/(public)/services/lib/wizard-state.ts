...
export function getInitialState(): WizardState {
  return {
    ...
    ndisManagementType: null,
    ndisForwardContactName: '',
    ndisForwardEmail: '',
    ndisEstimatedHours: 3,
    ndisHoursOrigin: 'suggested',
    ndisPropertyBedrooms: 3,
    ndisPropertyBathrooms: 2,
    ndisPropertyLiving: 1,
    ndisPropertyKitchens: 1,
    ndisPropertyLaundry: 1,
    ndisPropertyStoreys: 1,
    ndisYardSize: 'medium',

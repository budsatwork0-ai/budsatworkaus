...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navGroups: NavGroup[] = useMemo(() => [
    ...
    { id: 'growth', label: 'Growth', adminOnly: true, items: [
      ...
      { href: '/dashboard/research-lab', label: 'Research',    icon: researchLabIcon },
    ] },
    { id: 'content', label: 'Content', adminOnly: true, items: [
      { href: '/dashboard/content/story-intelligence', label: 'Story Intelligence', icon: insightsIcon },
      { href: '/dashboard/content',                    label: 'Campaign Factory',   icon: marketingIcon },
      ...
      { href: '/dashboard/story-engine/journal',       label: 'Journal',            icon: quotesIcon },
      { href: '/dashboard/content-studio/assets',      label: 'Story Assets',       icon: designIcon },
      { href: '/dashboard/content-vault',              label: 'Content Vault',      icon: researchLabIcon },
    ] },

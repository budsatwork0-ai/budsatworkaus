  ...
  const navSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/dashboard/applicants', label: 'Applicants', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" /></svg>, adminOnly: true },
      ],
    },
    {
      label: 'Operations',
      items: [
        ...
        { href: '/dashboard/onboarding', label: 'Onboarding', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>, adminOnly: true },

...
const DEFAULT_RECIPES: Recipe[] = [
  ...
  { key: 'assign_by_service', title: 'Auto-assign by Service',    desc: 'Assign owner based on first selected service.',                          enabled: true,  config: { Windows: 'Jackson', Lawns: 'Dean', Cleaning: 'Nate' } },
  ...
  { key: 'sla_escalate',    title: 'Escalate if Verify > 72h',     desc: 'Ping team lead if the Verify stage exceeds its SLA.',                    enabled: true,  config: { hours: 72, ping: 'Team Lead' } },
];

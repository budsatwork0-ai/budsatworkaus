 ...
 *
 * Runs the pipeline health-check and returns a 200 (healthy) or 500
 * (error). Warnings are surfaced in the JSON body and in server logs.
 * This endpoint can be called by a cron job or monitoring tool.
 */
